...
public class AktivitasTentor extends AppCompatActivity {
    ArrayAdapter<String> adapter_murid;
    List<Map<String, Object>> list_murid = new ArrayList<>();
    EditText filtermurid;
    LoginHelper helper;
    String nama,tgla,tglb;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_aktivitas_tentor);
        helper=new LoginHelper(AktivitasTentor.this);
        nama =getIntent().getStringExtra("NAMATENTOR");
        tgla =getIntent().getStringExtra("TGLAWAL");
        tglb =getIntent().getStringExtra("TGLAKHIR");
        getResponseMurid(AktivitasTentor.this,nama,tgla,tglb);
    }
    private void getResponseMurid(Activity activity,String username,String tgla,String tglb){
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(DETAILAKTIVITASAPI.PROFILURL)
                .addConverterFactory(ScalarsConverterFactory.create())
                .build();

        DETAILAKTIVITASAPI api = retrofit.create(DETAILAKTIVITASAPI.class);
        Call<String> call = api.getAktivitasTentor(nama,tgla,tglb);
            ...
            public void onResponse(Call<String> call, retrofit2.Response<String> response) {
                ...
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                        ...
                        loadProductToArrayMurid(jsonresponse, AktivitasTentor.this);
                    } else {
    ...
    private void loadProductToArrayMurid(String response,Activity activity){
        ...
        try {
            ...
            for (int i=0;i<list_murid.size();i++){
                ...
                products[i] = list_murid.get(i).get("NAMA").toString()+" - "+list_murid.get(i).get("HARI").toString()+ " "+list_murid.get(i).get("TANGGAL").toString()
            ...
            filtermurid.addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                    ...
                    AktivitasTentor.this.adapter_murid.getFilter().filter(cs);
                }
