...
public class RegistrasiTentor extends AppCompatActivity {
    LoginHelper helper;
    Button registrasi;
    EditText nama,jenjang,mapel,harijam,kisaran,alamat,email,password;
    ...
    private void RegistrasiTentor() {
        ...
        Call<String> call = api.getRegistrasiMurid(namatentor,jenjangtentor,mapeltentor,harijamtentor,kisarantentor,alamattentor,emailtentor,passwd);
