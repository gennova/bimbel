...
import com.aie.bimbelaie.tentor.LISTAKTIVITASAPI;
import com.aie.bimbelaie.tentor.List_Aktivitas_Tentor;
...
public class AktivitasTentor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(),getIntent().getStringExtra("NAMATENTOR"), Toast.LENGTH_SHORT).show();
        getResponseMurid(AktivitasTentor.this);
    }
    private void getResponseMurid(Activity activity){
        ...
        Call<String> call = api.getAktivitasTentor("tendy@yahoo.com");
